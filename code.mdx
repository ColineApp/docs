...
- Open and manage connected repositories
- Browse project files and folders
- Work across documentation, source code, and configuration together
...
Repository access and available workflows depend on workspace permissions and configured integrations.
