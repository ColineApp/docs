...
Many of these tools are also available directly inside [Coline Code](/docs/code) for AI-assisted repository workflows, editing, and implementation support.
...
This is separate from the [Coline Code](/docs/code) workspace experience. Code execution runs isolated scripts and automations rather than editing repository files directly or managing git workflows.
