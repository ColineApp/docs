...
Code execution is separate from [Coline Code](/docs/code). Coline Code is the collaborative editor and project workspace, while code execution runs temporary sandboxed scripts for automation and processing tasks.
